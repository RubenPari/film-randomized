 ...
 * Displays and manages the user's watchlist in a modal dialog.
 */
...
/**
 * Component to display and manage the user's watchlist in a modal.
 * 
 * @param {Object} props - Component props
 * @param {boolean} props.isOpen - Whether the modal is open
 * @param {Function} props.onClose - Function to close the modal
 * @returns {JSX.Element|null} Watchlist modal component or null if not open
 */
function Watchlist({ isOpen, onClose }) {
  ...
  /**
   * Loads watchlist when modal opens and token is available.
   */
  useEffect(
    function () {
      if (isOpen && token) {
        ...
        <div className="flex-1 overflow-y-auto p-6">
          {isLoading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 text-sm mt-2">Add content to get started!</p>
            </div>
          ) : (
